...
#ifndef BOOST_PARAMETERS_031014_HPP_EXBOOST
#define BOOST_PARAMETERS_031014_HPP_EXBOOST
...
namespace aux
{
  ...
  //    ...>
  //   >
#define EXBOOST_PARAMETER_make_arg_list(z, n, names)      \
      BOOST_PP_SEQ_ELEM(0,names)<                       \
          BOOST_PP_CAT(BOOST_PP_SEQ_ELEM(1,names), n),  \
          BOOST_PP_CAT(BOOST_PP_SEQ_ELEM(2,names), n),

#define EXBOOST_PARAMETER_right_angle(z, n, text) >

#define EXBOOST_PARAMETER_build_arg_list(n, make, parameter_spec, argument_type)      \
  BOOST_PP_REPEAT(                                                                  \
      n, EXBOOST_PARAMETER_make_arg_list, (make)(parameter_spec)(argument_type))      \
      mpl::identity<void_>                                                          \
  BOOST_PP_REPEAT(n, EXBOOST_PARAMETER_right_angle, _)

#define EXBOOST_PARAMETER_make_deduced_list(z, n, names)  \
      BOOST_PP_SEQ_ELEM(0,names)<                       \
          BOOST_PP_CAT(BOOST_PP_SEQ_ELEM(1,names), n),

#define EXBOOST_PARAMETER_build_deduced_list(n, make, parameter_spec)                 \
  BOOST_PP_REPEAT(                                                                  \
      n, EXBOOST_PARAMETER_make_deduced_list, (make)(parameter_spec))                 \
  mpl::identity<void_>                                                              \
  BOOST_PP_REPEAT(n, EXBOOST_PARAMETER_right_angle, _)
...
#define EXBOOST_PARAMETER_FORWARD_TYPEDEF(z, i, names) \
    typedef BOOST_PP_CAT(BOOST_PP_SEQ_ELEM(0,names),i) BOOST_PP_CAT(BOOST_PP_SEQ_ELEM(1,names),i);

#define EXBOOST_PARAMETER_FORWARD_TYPEDEFS(n, src, dest) \
    BOOST_PP_REPEAT(n, EXBOOST_PARAMETER_FORWARD_TYPEDEF, (src)(dest))


#define EXBOOST_PARAMETER_TEMPLATE_ARGS(z, n, text) class BOOST_PP_CAT(PS, n) = void_

template<
     class PS0
   , BOOST_PP_ENUM_SHIFTED(EXBOOST_PARAMETER_MAX_ARITY, EXBOOST_PARAMETER_TEMPLATE_ARGS, _)
>
struct parameters
{
#undef EXBOOST_PARAMETER_TEMPLATE_ARGS

    typedef typename EXBOOST_PARAMETER_build_deduced_list(
        EXBOOST_PARAMETER_MAX_ARITY, aux::make_deduced_items, PS
    )::type deduced_list;
...
# define EXBOOST_PARAMETER_satisfies(z, n, text)                                      \
            mpl::and_<                                                              \
            ...
            mpl::and_<
              ...
              , BOOST_PP_REPEAT(EXBOOST_PARAMETER_MAX_ARITY, EXBOOST_PARAMETER_satisfies, _)
                mpl::true_
                BOOST_PP_REPEAT(EXBOOST_PARAMETER_MAX_ARITY, EXBOOST_PARAMETER_right_angle, _)
            >

# undef EXBOOST_PARAMETER_satisfies
    ...
    template<
        ...
        // explicitly specify EXBOOST_PARAMETER_MAX_ARITY arguments
        BOOST_PP_ENUM_PARAMS(EXBOOST_PARAMETER_MAX_ARITY, class A)
#else
        BOOST_PP_ENUM_BINARY_PARAMS(
            EXBOOST_PARAMETER_MAX_ARITY, class A, = void_ BOOST_PP_INTERCEPT
        )
#endif
    >
    struct match
      ...
      : match_base<
            typename aux::make_arg_list<
                typename EXBOOST_PARAMETER_build_arg_list(
                    EXBOOST_PARAMETER_MAX_ARITY, aux::make_items, PS, A
                )::type
              , deduced_list
              , aux::tag_keyword_arg
              , mpl::false_ // Don't Q_EMIT errors when doing SFINAE
            >::type
        >::type
    {};
# else
    {
        typedef parameters<
            BOOST_PP_ENUM_PARAMS(EXBOOST_PARAMETER_MAX_ARITY, PS)
        > type;
    };
# endif
    ...
    EXBOOST_PARAMETER_FORWARD_TYPEDEFS(EXBOOST_PARAMETER_MAX_ARITY, PS, parameter_spec)
    ...
    operator()(A0& a0) const
    {
        ...
        return result_type(
            ...
            BOOST_PP_ENUM_TRAILING_PARAMS(
                BOOST_PP_SUB(EXBOOST_PARAMETER_MAX_ARITY, 1)
    ...
    operator()(A0& a0, A1& a1) const
    {
        ...
        return result_type(
            ...
            // , void_(), void_() ...
            BOOST_PP_ENUM_TRAILING_PARAMS(
                BOOST_PP_SUB(EXBOOST_PARAMETER_MAX_ARITY, 2)
              , aux::void_reference() BOOST_PP_INTERCEPT)
        );
    }
...
#define BOOST_PP_ITERATION_PARAMS_1 (3,( \
        3,EXBOOST_PARAMETER_MAX_ARITY,<exboost/parameter/aux_/overloads.hpp> \
    ))
...
#endif // BOOST_PARAMETERS_031014_HPP_EXBOOST
